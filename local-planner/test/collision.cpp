...
TEST(velocity_obstacle, getTimeToFirstCollision_iterative_1_static_obj_curve_no_collision) {
    ...
    obj1.odom.pose = { { meter_t(0.0), meter_t(0.0) }, degree_t(90) };
    obj1.odom.twist.speed = { m_per_sec_t(0.0), m_per_sec_t(1.0) };
    obj1.odom.twist.ang_vel = deg_per_sec_t(20.0);
...
TEST(velocity_obstacle, getTimeToFirstCollision_iterative) {
    ...
    DynamicObject obj3;
    obj3.radius = meter_t(1.5);
    obj3.odom.pose = { { meter_t(0.0), meter_t(5.0) }, degree_t(0) };
    obj3.odom.twist.speed = { m_per_sec_t(0.0), m_per_sec_t(1.0) };
    obj3.odom.twist.ang_vel = deg_per_sec_t(10.0);
    const ObjectTrajectory traj3 = getTrajectory(obj3, timeInterval, step);

    DynamicObject obj4;
    obj4.radius = meter_t(0.5);
    obj4.odom.pose = { { meter_t(3.0), meter_t(0.0) }, degree_t(0) };
